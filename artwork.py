...
def artwork():
    ...
    turtle.penup()
    turtle.goto(-245,10)
    turtle.write("O",move=False,align='center',font=("Œ¢»Ì—≈∫⁄",30,'normal'))
    turtle.pencolor("RED")
    turtle.penup()
    turtle.goto(-305,90)
    turtle.write("L",move=False,align='center',font=("Œ¢»Ì—≈∫⁄",30,'normal'))
    turtle.pencolor("YELLOW")
    turtle.penup()
    turtle.goto(-167,10)
    turtle.write("V",move=False,align='center',font=("Œ¢»Ì—≈∫⁄",30,'normal'))
    turtle.pencolor("GREEN")
    #turtle.penup()
    turtle.goto(-117, 90)
    turtle.write("E",move=False,align='center',font=("Œ¢»Ì—≈∫⁄",30,'normal'))
    turtle.pencolor("PINK")
    turtle.penup()
    turtle.goto(300, 200)
    turtle.write(str,move=False,align='center',font=("∑Ω’˝ ÊÃÂ",30,'normal'))
